...
public class ScoresDataTest {
    ...
    public void testSetScore() {
        scoresData.registerObserver(observer);
        scoresData.registerObserver(observer);
        scoresData.setScore("testTeam1", "testTeam2", 1, 0, 0, "testName", "testPosition", "testTeam");
        verify(observer, times(2)).update("testTeam", "testTeam2", 1, 0, 0, "testName", "testPosition", "testTeam");
    }
}
